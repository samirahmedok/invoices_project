						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								<a href="invoices/create" class="modal-effect btn btn-sm btn-primary" style="color: white;width: 200px;">
									<i class="fas fa-plus"></i>&nbsp;Add an invoice</a>
								@endcan
							</div>
							<div class="card-body">
																...
																@can('ارشفة الفاتورة')
																	<a class="dropdown-item" href="#" data-invoice_id="{{ $inv->id }}"
																		data-toggle="modal" data-target="#Transfer_invoice"><i
																			class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;move to archive</a>
																@endcan
																@can('طباعةالفاتورة')
																<a class="dropdown-item" href="{{url('invoice_print')}}/{{$inv->id}}"><i class="text-success fas fa-pen-alt"></i>&nbsp;print_invoice</a>
																@endcan
															</div>
													</div>
												</td>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('invoices.destroy' , 'test')}}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="invoice_id" id="invoice_id" value="" readonly style="width: 50px;text-align:center">
                    </div>
