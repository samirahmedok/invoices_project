					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
									...
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">
												<a href="MarkAsRead_all">Mark All as Read</a>
											</span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12" id="notifications_count">You have<span style="color: yellow;font-size:20px">{{ auth()->user()->unreadNotifications->count() }}</span>unread Notifications</p>
									</div>
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/personal_img.jpg')}}"></a>
								<div class="dropdown-menu">
